    ...
    <>
      <nav className="bg-white shadow-lg border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex md:flex-nowrap flex-wrap items-center  mx-auto p-4">
          ...
          <div
            className="hidden    w-full md:flex md:w-auto justify-between"
            id="navbar-default"
          >
            {token ? (
            ...
            <ul className="font-medium  flex   md:p-0 mt-4 ">
              ...
              {token ? (
                <>
                  <li className="relative text-green-500">
                    {" "}
                    <i className="fa-solid fa-cart-shopping"></i>
                    <span className=" absolute top-0 end-0 -translate-y-4 translate-x-2">
                      {numCartItems}
                    </span>
                  </li>
                  <li className="relative left-96 " onClick={logout}>
                    <span>logout</span>
                  </li>
                </>
              ) : (
